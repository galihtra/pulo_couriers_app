import 'dart:async';
import 'package:pulo_couriers_app/methods/common_methods.dart';
import 'package:pulo_couriers_app/methods/map_theme_methods.dart';
import 'package:pulo_couriers_app/models/trip_details.dart';
import 'package:pulo_couriers_app/widgets/payment_dialog.dart';
...
class _NewTripPageState extends State<NewTripPage>
{
  ...
  getLiveLocationUpdatesOfDriver()
  {
    ...
    positionStreamNewTripPage = Geolocator.getPositionStream().listen((Position positionDriver)
    {
      ...
      FirebaseDatabase.instance.ref().child("tripRequestsCourier")
  ...
  endTripNow() async
  {
    ...
    await FirebaseDatabase.instance.ref().child("tripRequestsCourier")
        .child(widget.newTripDetailsInfo!.tripID!)
