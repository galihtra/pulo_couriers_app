import 'package:pulo_couriers_app/pages/trips_history_page.dart';
...
class _TripsPageState extends State<TripsPage> 
{
  ...
  {
    DatabaseReference tripRequestsRef = FirebaseDatabase.instance.ref().child("tripRequestsCourier");
